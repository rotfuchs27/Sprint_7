...
class TestLoginCourier:
    ...
    def test_courier_authorization_success(self, existing_user_payload):
    ...
    def test_login_missing_login_failure(self, existing_user_payload):
        payload = {
            "login": "",
    ...
    def test_login_missing_password_failure(self, existing_user_payload):
        payload = {
    ...
    def test_courier_not_existing_login_failure(self, existing_user_payload):
        payload = {
